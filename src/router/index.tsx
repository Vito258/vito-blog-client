...
const router = createBrowserRouter([
		...
		children:[
			...
			{
				path:"/donations",
				element:<Suspense fallback={"加载中..."}><Donations/></Suspense>
			},
			{
				path:"/chatroom",
				element:<Suspense fallback={"加载中..."}><ChatRoom/></Suspense>
			},
			{
				path:"/messages",
				element:<Suspense fallback={"加载中..."}><Messages/></Suspense>
			},
			{
				path:"/notes",
				element:<Suspense fallback={"加载中..."}><NotesAndChats/></Suspense>
			},
			{
				path:"/projectshare",
				element:<Suspense fallback={"加载中..."}><ProjectShare/></Suspense>
			},
			{
				path:"/techtalk",
				element:<Suspense fallback={"加载中..."}><TechTalk/></Suspense>
			},
		]
   	  },
	])
